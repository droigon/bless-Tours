...
async function fetchUserData(userId: string): Promise<PostProps | null> {
  try {
    const response = await fetch(`https://blesstours.onrender.com/api/v1/tours/${userId}`);
    if (!response.ok) {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        ...
        setPost(tourData.data)
        console.log("osts:", tourID);
      } catch (error) {
                ...
                <div className="grid grid-cols-12 gap-4 md:gap-3 mb-8">
                  ...
                  <div className="col-span-12 md:col-span-4">
                    <div className="border border-neutral-40 rounded-2xl bg-[var(--bg-1)] py-4 px-8">
                      ...
                      <p className="mb-0 text-lg font-medium"> {location}</p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="property-card__body">
                      ...
                      <div className="flex justify-between gap-3">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="inline-block"> {post?.LOCATION} </span>
                        </div>
                        <div className="flex items-center gap-1">
                      ...
                      <ul className="flex flex-wrap gap-6">
                        <li>
                         ...
                         Duration
                          ...
                          <span className="block text-sm">  {post?.DURATION}</span>
                        </li>
                        <li>
                          <span className="material-symbols-outlined mat-icon clr-neutral-600 inline-block mb-1">
                           Start point
